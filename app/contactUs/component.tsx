...
export function ContactSection14() {
  // Controlled inputs (same fields as your current form)
      ...
      <section className="mx-auto max-w-6xl pb-10">
        ...
        <div className="container  mx-auto flex sm:flex-nowrap flex-wrap ">
          ...
          <div className="lg:w-1/3 md:w-1/2 bg-white flex flex-col md:ml-auto w-full md:py-8 mt-8 md:mt-0 px-4">
            ...
            {/* Controlled form using your existing fields/markup */}
            <form onSubmit={onSubmit} className="mt-4" noValidate>
              <div className=" mb-4">
                <label
                  htmlFor="name"
                  className="leading-7 text-sm text-background/80"
                >
                  Name
                </label>
                <input
                  ...
                  className="w-full bg-white rounded border border-gray-300 focus:border-primary focus:ring-2 focus:ring-primary text-base outline-none text-gray-700 py-1 px-3 leading-8 transition-colors duration-200 ease-in-out disabled:opacity-60"
                />
              </div>
              ...
              <div className=" mb-4">
                ...
                <textarea
                  ...
                  onChange={handleChange}
                  className="w-full bg-white rounded border border-gray-300 focus:border-primary focus:ring-2 focus:ring-primary h-32 text-base outline-none text-gray-700 py-1 px-3 resize-none leading-6 transition-colors duration-200 ease-in-out disabled:opacity-60"
                ></textarea>
              </div>
