          ...
          <address className="not-italic text-background/80">
            <div className="flex flex-wrap items-start gap-4 sm:gap-6">
              <div className="flex items-center gap-2 text-xs sm:text-sm opacity-80">
                <Link href="https://maps.app.goo.gl/KXxKTmBJ1qwckS8W6" target="_blank" className="hover:underline focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-background/50 rounded flex items-center gap-2">
