...
const TESTIMONIALS: Testimonial[] = [
  {
    ...
    consent: true,
    content: `My name is Pratigya Pagaar, and I live in Bhikangaon, in Khargone district. I work to raise awareness among girls and encourage them to move forward in society. To us, JSSES is a helpful and supportive NGO where we share our diverse problems, and they help in finding appropriate solutions. They work in the field of education and raise awareness among underprivileged children and women. I have known JSSES for a long time, and they have supported me in many ways. I sincerely thank the JSSES for their help. It is an important social organisation.`,
  },
  {
    id: "indore-anganwadi",
  ...
  },
  {
    ...
    location: "Indore",
    consent: true,
    content: `JSSES works to prevent harassment and domestic violence against women. It also helps adolescent girls overcome mental and physical difficulties they face. It has helped adolescent girls a lot in overcoming their problems. It has helped me a lot too, in emotionally balancing depression, stress, and anger. Thank you! This organisation also works to eliminate social superstitions and helps women understand their responsibilities and preserve their self-respect. Without discriminating between people, JSSES listens to the mental and physical problems of girls and women and helps find solutions. Thank you JSSES!`,
  },
];
...
function TestimonialCard({
  ...
  return (
    ...
    >
      ...
      {/* Body */}
      <p className="text-xs md:text-sm opacity-60 pt-6 lg:text-lg">{preview}</p>
